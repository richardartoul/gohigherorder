...
var (
	generatedTemplate = template.Must(template.New("render").Parse(`// generated by gohigherorder -- DO NOT EDIT
package {{.Package}}
...
func isAnnotatedTypeDecl(decl *ast.GenDecl) bool {
	...
	for _, comment := range decl.Doc.List {
		// Look for gohigherorder or //gohigherorder on a newline followed by any (or no) whitespace
		isAnnotated, _ := regexp.MatchString("(?m)^(//)?gohigherorder\\s*$", comment.Text)
		if isAnnotated {
			return true
		}
	}
